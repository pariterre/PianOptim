...
def prepare_ocp(
    ...
    phase_time1 = (0.3, 0.027, 0.058, 0.15, 0.15)
    ...
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_STATE, key="q", phase=0, weight=0.0001, index=[0, 1, 2, 3, 4]
    )
    objective_functions.add(
    ...
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_STATE, key="qdot", phase=4, weight=1000, index=[5, 6], derivative=True
    )
    ...
    # x_bounds[0]["q"][[5], 0] = 0.59
    # x_bounds[0]["q"][[6], 0] = 0.28

    x_bounds[4]["q"][[5], 2] = -0.25
    # x_bounds[4]["q"][[6], 2] = 0.28
    # Initial guess
