...
axs[0, 0].plot(nodes, Wrist_C_T_lambda_DT, label='Wrist (DT)', marker='o', color='red')
axs[0, 0].plot(nodes, Wrist_C_T_lambda_ST, label='Wrist (ST)', marker='^', color='blue')
axs[0, 0].set_title('Wrist -C_T_lambda Contributions', fontsize=16)
axs[0, 0].set_xlabel('Node', fontsize=14)
axs[0, 0].set_ylabel('C_T_lambda Value', fontsize=14)
axs[0, 0].legend(fontsize=12)
axs[0, 0].grid(True)
axs[0, 0].tick_params(axis='both', labelsize=12)

# Plotting C_T_lambda values for MCP
axs[1, 0].plot(nodes, MCP_C_T_lambda_DT, label='MCP (DT)', marker='s', color='red')
axs[1, 0].plot(nodes, MCP_C_T_lambda_ST, label='MCP (ST)', marker='x', color='blue')
axs[1, 0].set_title('MCP -C_T_lambda Contributions', fontsize=16)
axs[1, 0].set_xlabel('Node', fontsize=14)
axs[1, 0].set_ylabel('C_T_lambda Value', fontsize=14)
axs[1, 0].legend(fontsize=12)
axs[1, 0].grid(True)
axs[1, 0].tick_params(axis='both', labelsize=12)

# Plotting Nonlinear_Effects values for Wrist
axs[0, 1].plot(nodes, Wrist_Nonlinear_Effects_DT, label='Wrist (DT)', marker='o', color='red')
axs[0, 1].plot(nodes, Wrist_Nonlinear_Effects_ST, label='Wrist (ST)', marker='^', color='blue')
axs[0, 1].set_title('Wrist Nonlinear Effects Contributions', fontsize=16)
axs[0, 1].set_xlabel('Node', fontsize=14)
axs[0, 1].set_ylabel('Nonlinear Effects Value', fontsize=14)
axs[0, 1].legend(fontsize=12)
axs[0, 1].grid(True)
axs[0, 1].tick_params(axis='both', labelsize=12)

# Plotting Nonlinear_Effects values for MCP
axs[1, 1].plot(nodes, MCP_Nonlinear_Effects_DT, label='MCP (DT)', marker='s', color='red')
axs[1, 1].plot(nodes, MCP_Nonlinear_Effects_ST, label='MCP (ST)', marker='x', color='blue')
axs[1, 1].set_title('MCP Nonlinear Effects Contributions', fontsize=16)
axs[1, 1].set_xlabel('Node', fontsize=14)
axs[1, 1].set_ylabel('Nonlinear Effects Value', fontsize=14)
axs[1, 1].legend(fontsize=12)
axs[1, 1].grid(True)
axs[1, 1].tick_params(axis='both', labelsize=12)

# Plotting Mass_Qddot values for Wrist
axs[0, 2].plot(nodes, Wrist_Mass_Qddot_DT, label='Wrist (DT)', marker='o', color='red')
axs[0, 2].plot(nodes, Wrist_Mass_Qddot_ST, label='Wrist (ST)', marker='^', color='blue')
axs[0, 2].set_title('Wrist Mass_Qddot Contributions', fontsize=16)
axs[0, 2].set_xlabel('Node', fontsize=14)
axs[0, 2].set_ylabel('Mass_Qddot Value', fontsize=14)
axs[0, 2].legend(fontsize=12)
axs[0, 2].grid(True)
axs[0, 2].tick_params(axis='both', labelsize=12)

# Plotting Mass_Qddot values for MCP
axs[1, 2].plot(nodes, MCP_Mass_Qddot_DT, label='MCP (DT)', marker='s', color='red')
axs[1, 2].plot(nodes, MCP_Mass_Qddot_ST, label='MCP (ST)', marker='x', color='blue')
axs[1, 2].set_title('MCP Mass_Qddot Contributions', fontsize=16)
axs[1, 2].set_xlabel('Node', fontsize=14)
axs[1, 2].set_ylabel('Mass_Qddot Value', fontsize=14)
axs[1, 2].legend(fontsize=12)
axs[1, 2].grid(True)
axs[1, 2].tick_params(axis='both', labelsize=12)

# Plotting Tau_values for Wrist
axs[0, 3].plot(nodes, Wrist_Tau_DT, label='Wrist (DT)', marker='o', color='red')
axs[0, 3].plot(nodes, Wrist_Tau_ST, label='Wrist (ST)', marker='^', color='blue')
axs[0, 3].set_title('Wrist Tau Values Contributions', fontsize=16)
axs[0, 3].set_xlabel('Node', fontsize=14)
axs[0, 3].set_ylabel('Tau Value', fontsize=14)
axs[0, 3].legend(fontsize=12)
axs[0, 3].grid(True)
axs[0, 3].tick_params(axis='both', labelsize=12)

# Plotting Tau_values for MCP
axs[1, 3].plot(nodes, MCP_Tau_DT, label='MCP (DT)', marker='s', color='red')
axs[1, 3].plot(nodes, MCP_Tau_ST, label='MCP (ST)', marker='x', color='blue')
axs[1, 3].set_title('MCP Tau Values Contributions', fontsize=16)
axs[1, 3].set_xlabel('Node', fontsize=14)
axs[1, 3].set_ylabel('Tau Value', fontsize=14)
axs[1, 3].legend(fontsize=12)
axs[1, 3].grid(True)
axs[1, 3].tick_params(axis='both', labelsize=12)
