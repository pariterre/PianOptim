...
def prepare_ocp(allDOF, struck, ode_solver) -> OptimalControlProgram:
...
def main():
    ...
    if allDOF:
        saveName = "/home/alpha/Desktop/22Nov._Updated_BioMod/struck_with_Thorax.pckl"
        nq = 10
    else:
        saveName = "/home/alpha/Desktop/22Nov._Updated_BioMod/struck_without_Thorax.pckl"
        nq = 7

    ocp = prepare_ocp(allDOF=allDOF, struck=struck, ode_solver=OdeSolver.COLLOCATION(polynomial_degree=polynomial_degree))
