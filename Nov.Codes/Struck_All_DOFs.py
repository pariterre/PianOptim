...
def prepare_ocp(
    ...
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_STATE, key="qdot", phase=4, weight=1000, index=[8, 9], derivative=True
    )
...
def main():
    ...
    with open("/home/alpha/Desktop/Nov. 14/Struck_with_Thorax.pckl", "wb") as file:
